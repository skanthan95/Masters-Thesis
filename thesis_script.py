...
il_w2v = gensim.models.word2vec.Word2Vec(model_ready_mb)
...
def book_nlp_parse(data, keyword_list):
  '''
...
## call book_nlp_pase on each text's list of tokens for each keyword;
## eg. book_nlp_parse(il_tokens, spears)
